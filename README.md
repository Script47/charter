...
`charter version` shows where both stand:
...
v0.0.9-dev is available. Run charter update --self
https://github.com/Script47/charter/releases/tag/v0.0.9-dev
```
